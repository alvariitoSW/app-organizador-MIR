...
const files=['Main','Sesion','Rutinas','Progreso','Biblioteca'];
...
for(const f of files){
  ...
  await p.screenshot({path:'/tmp/claude-0/-home-user-app-organizador-MIR/04570ec0-ed89-58d2-8ae8-39a350c9b3cb/scratchpad/mk-'+f+'.png',fullPage:true});
  await p.close();
}
await b.close();
